...
public class TreeveTest {
    ...
    public static void main(String[] args) throws 
        ...
        int account0 = mySocialMedia.createAccount("testman0");

        int post0 = mySocialMedia.createPost("testman0", "aaaaaaaaa");
        
        int endorsement0 = mySocialMedia.endorsePost("testman0", post0);

        System.out.println(mySocialMedia.showIndividualPost(endorsement0));
